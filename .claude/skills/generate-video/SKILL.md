...
name: generate-video
description: >
  Generate short videos from images. Each image is paired with a .txt prompt
  file of the same name and turned into a .mp4 video using wan-video on
  Replicate. Use when asked to create videos from images, animate images,
  or generate video content.
metadata:
  category: content

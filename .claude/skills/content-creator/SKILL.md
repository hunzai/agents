...
description: >
  ...
  images → videos → narrated audio. Chains modular skills: transcribe,
  translate, generate-images, generate-video, narrate. Use when asked to
...
```
audio → transcribe → story.txt → translate → urdu.txt

...
description: >
  Transcribe audio files to text using ElevenLabs speech-to-text. Takes a
  directory of audio files, transcribes each to .txt, then combines into a
  single clean transcript. Supports flac, wav, mp3, ogg, opus, m4a, webm.
  Use when asked to transcribe audio, convert speech to text, or extract
  text from recordings.
metadata:
  category: audio
